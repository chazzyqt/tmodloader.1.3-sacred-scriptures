...
{
    //Projectile for the DevStaff
    public class AbsoluteExplosion : ModProjectile
    {
        ...
        public const int chargeTicksIdle = 1; //6
        public const int chargeTicksMax = 1 * (1 + chargeTicksIdle); //lower faster charge
        public const float chargeTickGameMax = (chargeTicksMax / chargeTicksIdle);
        public const int castTicksTime = 5; //cast to fire time
        public const int fireTicksTime = 3;
        public const float manaIncrease = 0; //0.8f
        public const int manaMaintainCost = 1;
        ...
        {
            DisplayName.SetDefault("Cataclysmic Event");
            if(!Main.dedServ)
            {
